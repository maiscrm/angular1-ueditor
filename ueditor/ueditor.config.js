...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: window.config.ajaxapiDomain + "/api/ueditor/file"

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        , toolbars: [
          ['undo', 'redo', '|', 'fontsize', '|', 'blockquote', 'horizontal', '|', 'removeformat', 'formatmatch', 'link', 'unlink', 'fullscreen'],
